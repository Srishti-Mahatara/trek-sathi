  ...
  const features = [
    {
      ...
      description:
        "AI-powered destination recommendations based on your preferences and travel history.",
    ...
    },
    {
      ...
      description:
        "Create optimized itineraries with real-time traffic updates and local insights.",
    ...
    },
    {
      ...
      title: "Photo Sharing",
      description:
        "Share your travel moments and discover hidden gems through community photos.",
    ...
    },
    {
      ...
      description:
        "Save your favorite destinations and create personalized travel collections.",
    ...
    },
    {
      ...
      description:
        "Connect with fellow travelers, share experiences, and get local recommendations.",
    ...
    },
    {
      ...
      title: "Safe Travel",
      description:
        "Real-time safety alerts, emergency contacts, and travel insurance options.",
    ...
    <div className="w-full space-y-xl">
      ...
      <section className="bg-gradient-to-r from-primary to-primary-dark text-white rounded-lg p-xl text-center">
        <div className="mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-xl opacity-90">
            Your complete travel companion for exploring the world's most
      ...
      <section className="bg-white rounded-lg shadow-md p-xl">
        <div className="text-center mb-xl">
          ...
          <p className="text-gray-600 text-lg">
            Join millions of adventurers who trust us with their journeys
          </p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-lg">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div
                className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-gray-50 mb-md ${stat.color}`}
              >
                <stat.icon size={32} />
              </div>
      ...
      <section className="bg-white rounded-lg shadow-md p-xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-lg">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-gray-50 rounded-lg p-lg hover:shadow-md transition-shadow"
            >
              <div
                className={`inline-flex items-center justify-center w-12 h-12 rounded-lg mb-md ${feature.color}`}
              >
                <feature.icon size={24} />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-xs">
                {feature.title}
              </h3>
      ...
      <section className="bg-white rounded-lg shadow-md p-xl">
        <div className="text-center mb-xl">
          ...
          <p className="text-gray-600 text-lg">
            Your journey from planning to exploration in simple steps
          </p>
        </div>
              ...
              <div className="">
                <div className="bg-gray-50 rounded-lg p-lg">
                  ...
                  <p className="text-gray-600">
                    Search and explore destinations tailored to your interests
                    and budget
                  </p>
                </div>
              </div>
            ...
            <div className="w-1/2 ">
              ...
              <div className="">
                <div className="bg-gray-50 rounded-lg p-lg">
                  ...
                  <p className="text-gray-600">
                    Create detailed itineraries with smart scheduling and local
                    recommendations
                  </p>
                </div>
              </div>
            ...
            <div className="w-1/2">
              <div className="">
                <div className="bg-gray-50 rounded-lg p-lg">
                  ...
                  <p className="text-gray-600">
                    Use offline maps and real-time guidance to explore with
                    confidence
                  </p>
                </div>
              </div>
            ...
            <div className="w-1/2">
              ...
              <div className="">
                <div className="bg-gray-50 rounded-lg p-lg">
                  ...
                  <p className="text-gray-600">
                    Document your journey and inspire others with your travel
                    stories
                  </p>
                </div>
              </div>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-xl -mt-lg">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-lg">
          {systemHighlights.map((highlight, index) => (
            <div
              key={index}
              className="bg-white rounded-lg p-lg text-center hover:shadow-md transition-shadow"
            >
      ...
      <section className="bg-white rounded-lg shadow-md p-xl">
        <div className="text-center mb-xl">
          ...
          <p className="text-gray-600 text-lg">
            Real-time insights into travel trends and platform usage
          </p>
        </div>
